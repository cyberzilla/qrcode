...
<head>
    ...
    <title>QR Code Generator(php 5+)</title>
...
<body>
    ...
    <div class="wrap">
        ...
        <div class="grid">
            ...
            <div class="card anim ad1">
                ...
                <div class="fg">
                    ...
                    <textarea class="ft" id="text" placeholder="Enter URL, text, or any data…">https://github.com</textarea>
                </div>
        ...
        <footer class="footer">
            QRCode3.php — Single-file PHP QR Code Generator • MIT License
        </footer>
    </div>
    ...
    async function generate() {
        ...
        try {
            const res = await fetch('api3.php', { method: 'POST', body: fd });
